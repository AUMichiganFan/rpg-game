...
function buyHealth(){
    if (gold>=10){
        ...
        text.innerText("you do not have enough health")
    }
...
function buyWeapon(){
    ...
    if (currentWeapon<weapons.length -1){
        ...
        text.innerText("you already have the max weapon")
...
function goFight(){
    update(locations[3])
    monsterHealth=monsters[fighting].healthS
}
